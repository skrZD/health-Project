...
uCharts.prototype.zoom = function() {
  ...
  if (this.opts.enableScroll !== true) {
    common_vendor.index.__f__("log", "at uni_modules/qiun-data-charts/js_sdk/u-charts/u-charts.js:7193", "[uCharts] 请启用滚动条后使用");
    return;
  }
...
uCharts.prototype.dobuleZoom = function(e) {
  if (this.opts.enableScroll !== true) {
    common_vendor.index.__f__("log", "at uni_modules/qiun-data-charts/js_sdk/u-charts/u-charts.js:7233", "[uCharts] 请启用滚动条后使用");
    return;
  }
...
uCharts.prototype.showToolTip = function(e) {
  ...
  if (!touches) {
    common_vendor.index.__f__("log", "at uni_modules/qiun-data-charts/js_sdk/u-charts/u-charts.js:7411", "[uCharts] 未获取到event坐标信息");
  }
